...
def main() -> None:
    ...
    parser.add_argument("--regional_aug", type=str, default="dataset/cambodian_asia_banking_qa_2016.csv")
    parser.add_argument("--asia_custom_aug", type=str, default="dataset/cambodian_asia_banking_custom.csv")
    ...
    parser.add_argument("--cambodia_only", action="store_true")
